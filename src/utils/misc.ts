...
import { EQUICORD_HELPERS, RetributionDevsById, GUILD_ID, KNOWN_ISSUES_CHANNEL_ID, SUPPORT_CHANNEL_ID, VencordDevsById } from "./constants";
...
export const isRetributionPluginDev = (id: string) => Object.hasOwn(RetributionDevsById, id);
export const shouldShowRetributionContributorBadge = (id: string) => isRetributionPluginDev(id) && RetributionDevsById[id].badge !== false;

export const isAnyPluginDev = (id: string) => Object.hasOwn(VencordDevsById, id) || Object.hasOwn(RetributionDevsById, id);
...
export function isRetributionGuild(id: string | null | undefined, isGuildId: boolean = false): boolean {
    if (!id) return false;
...
export function isRetributionSupport(userId: string | null | undefined): boolean {
