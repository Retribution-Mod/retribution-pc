...
const CHANGELOG_HISTORY_KEY = "RetributionChangelog_History";
const LAST_SEEN_HASH_KEY = "RetributionChangelog_LastSeenHash";
const KNOWN_PLUGINS_KEY = "RetributionChangelog_KnownPlugins";
const KNOWN_SETTINGS_KEY = "RetributionChangelog_KnownSettings";
const LAST_REPO_CHECK_KEY = "RetributionChangelog_LastRepoCheck";
