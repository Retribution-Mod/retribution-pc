    ...
    const pluginInfo = [
        {
            ...
            src: "https://github.com/Retribution-Mod/retribution-pc/assets/icons/equicord/modified.png",
            alt: "Modified",
            title: "Modified Vencord Plugin"
        },
        {
            condition: isRetributionPlugin,
            src: "https://raw.githubusercontent.com/Retribution-Mod/retribution-pc/main/browser/icon.png",
            alt: "Retribution",
            title: "Retribution Plugin"
        },
        {
            condition: isVencordPlugin,
            src: "https://github.com/Retribution-Mod/retribution-pc/assets/icons/vencord/icon-light.png",
            alt: "Vencord",
            title: "Vencord Plugin"
        },
        {
            condition: isUserPlugin,
            src: "https://github.com/Retribution-Mod/retribution-pc/assets/icons/misc/userplugin.png",
            alt: "User",
            title: "User Plugin"
        }
    ];
