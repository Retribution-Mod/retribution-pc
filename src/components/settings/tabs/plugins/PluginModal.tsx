                            ...
                            <UserSummaryItem
                                ...
                                renderUser={(user: User) => (
                                    <Clickable
                                        ...
                                        onClick={() => isRetributionPlugin ? openContributorModal(user) : openContributorModal(user)}
                                    >
                                        <img
                    ...
                    <Flex style={{ justifyContent: "space-between", alignItems: "center" }}>
                        ...
                        {!pluginMeta.userPlugin && (
                            <div className={cl("links")}>
                                ...
                                <WebsiteButton
                                    text="Website"
                                    href={isRetributionPlugin ? `https://github.com/Retribution-Mod/retribution-pc/plugins/${plugin.name}` : `https://vencord.dev/plugins/${plugin.name}`}
                                />
                                <GithubButton
                                    text="Source Code"
