...
const SHIGGY_DONATE_IMAGE = "https://raw.githubusercontent.com/Retribution-Mod/retribution-pc/main/browser/icon.png";
...
function RetributionSettings() {
    ...
    return (
        <SettingsTab>
            {(isRetributionDonor(user?.id) || isVencordDonor(user?.id)) ? (
                <SpecialCard
                    title="Donations"
                    subtitle="Thank you for donating!"
                    description={
                        isRetributionDonor(user?.id) && isVencordDonor(user?.id)
                            ? "All Vencord users can see your Vencord donor badge, and Retribution users can see your Retribution donor badge. To change your Vencord donor badge, contact @vending.machine. For your Retribution donor badge, make a ticket in Retribution's server."
                            : isVencordDonor(user?.id)
                                ? "All Vencord users can see your badge! You can manage your perks by messaging @vending.machine."
                                : "All Retribution users can see your badge! You can manage your perks by making a ticket in Retribution's server."
                    }
                ...
                <SpecialCard
                    ...
                    description="Please consider supporting the development of Retribution by donating!"
            ...
            {isAnyPluginDev(user?.id) && (
                <SpecialCard
                    ...
                    description="Since you've contributed to Retribution you now have a cool new badge!"
            ...
            <Paragraph className={Margins.bottom16}>
                Configure how Retribution behaves and integrates with Discord. These settings affect the Discord client's appearance and behavior.
            </Paragraph>
...
export default wrapTab(RetributionSettings, "Retribution Settings");

export function isRetributionDonor(userId: string): boolean {
    const donorBadges = BadgeAPI.getRetributionDonorBadges(userId);
