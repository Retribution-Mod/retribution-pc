...
function EquibopSection() {
    ...
    return (
        <Flex className={Margins.bottom20} flexDirection="column" gap="1em">
            <Card variant="brand">
                <HeadingSecondary>Equibop & Retribution</HeadingSecondary>
                <Paragraph>Equibop and Retribution are two separate things. This updater is for Retribution.</Paragraph>
    ...
    return (
        <SettingsTab>
            ...
            <Paragraph className={Margins.bottom20}>
                Control how Retribution keeps itself up to date. You can choose to update automatically in the background or be notified when new updates are available.
            </Paragraph>

            <FormSwitch
                title="Automatically update"
                description="When enabled, Retribution will automatically download and install updates in the background without asking for confirmation. You'll need to restart Discord to apply the changes."
            ...
            <FormSwitch
                ...
                description="Receive a notification when Retribution finishes downloading an update in the background, so you know when to restart Discord."
            ...
            <Paragraph className={Margins.bottom8}>
                This is the GitHub repository where Retribution fetches updates from.
            </Paragraph>
