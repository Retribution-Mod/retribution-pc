...
const NOTIFICATION_AUDIO_URL = "https://raw.githubusercontent.com/Retribution/Equibored/main/sounds/waitForSlot/notification.mp3";
...
export default definePlugin({
    ...
    authors: [RetributionDevs.omaw, Devs.prism],
    settings,
    patches: [
        {
