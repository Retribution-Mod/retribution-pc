...
const settings = definePluginSettings({
    showRetributionDonor: {
        type: OptionType.BOOLEAN,
        description: "Enable to show Retribution Donor badges in chat.",
        hidden: true,
        default: true
    },
    RetributionDonorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the Retribution Donor badges.",
        hidden: true,
        default: 0
    },
    showRetributionContributor: {
        type: OptionType.BOOLEAN,
        description: "Enable to show Retribution Contributor badges in chat.",
        hidden: true,
        default: true
    },
    RetributionContributorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the Retribution Contributor badge.",
        hidden: true,
        default: 1
    },
    showVencordDonor: {
...
const BadgeSettings = () => {
    const [images, setImages] = useState([
        { src: "https://badge.equicord.org/donor.webp", shown: settings.store.showRetributionDonor, title: "Retribution donor badges", key: "RetributionDonor", position: settings.store.RetributionDonorPosition },
        { src: "https://raw.githubusercontent.com/Retribution-Mod/retribution-pc/main/browser/icon.png", shown: settings.store.showRetributionContributor, title: "Retribution contributor badge", key: "RetributionContributer", position: settings.store.RetributionContributorPosition },
    ...
    useEffect(() => {
        images.forEach(image => {
            switch (image.key) {
                case "RetributionDonor":
                    settings.store.RetributionDonorPosition = image.position;
                    settings.store.showRetributionDonor = image.shown;
                    break;
                case "RetributionContributer":
                    settings.store.RetributionContributorPosition = image.position;
                    settings.store.showRetributionContributor = image.shown;
                    break;
                case "VencordDonor":
