...
export const actions: ButtonAction[] = [
    { id: "openRetributionSettings", label: "Open Retribution tab", callback: async () => await SettingsRouter.openUserSettings("equicord_main_panel"), registrar: "Retribution" },
    { id: "openPluginSettings", label: "Open Plugin tab", callback: () => SettingsRouter.openUserSettings("equicord_plugins_panel"), registrar: "Retribution" },
    { id: "openThemesSettings", label: "Open Themes tab", callback: () => SettingsRouter.openUserSettings("equicord_themes_panel"), registrar: "Retribution" },
    { id: "openUpdaterSettings", label: "Open Updater tab", callback: () => SettingsRouter.openUserSettings("equicord_updater_panel"), registrar: "Retribution" },
    { id: "openRetributionCloudSettings", label: "Open Cloud tab", callback: () => SettingsRouter.openUserSettings("equicord_cloud_panel"), registrar: "Retribution" },
    { id: "openBackupSettings", label: "Open Backup & Restore tab", callback: () => SettingsRouter.openUserSettings("equicord_backup_restore_panel"), registrar: "Retribution" },
    { id: "restartClient", label: "Restart Client", callback: () => relaunch(), registrar: "Retribution" },
    { id: "openQuickCSSFile", label: "Open Quick CSS File", callback: () => VencordNative.quickCss.openEditor(), registrar: "Retribution" },
    { id: "openSettingsFolder", label: "Open Settings Folder", callback: async () => showItemInFolder(await VencordNative.settings.getSettingsDir()), registrar: "Retribution" },
    { id: "openInGithub", label: "Open in Github", callback: async () => VencordNative.native.openExternal(await getRepo()), registrar: "Retribution" },
        ...
        id: "checkForUpdates", label: "Check for Updates", callback: async () => {
            ...
            if (isOutdated) {
                setTimeout(() => showNotification({
                    title: "A Retribution update is available!",
