...
export default definePlugin({
    ...
    tags: ["Fun"],
    authors: [RetributionDevs.SomeAspy, Devs.thororen],
    dependencies: ["AudioPlayerAPI"],
    settings,
    start() {
        croissant = createAudioPlayer("https://github.com/Retribution/Equibored/raw/main/sounds/equissant/croissant.mp3", { persistent: true });
