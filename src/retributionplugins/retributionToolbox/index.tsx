        ...
        >
            {(_, { isShown }) => (
                <HeaderBarButton
                    ...
                    onClick={() => setShow(v => !v)}
                    tooltip={isShown ? null : "Retribution Toolbox"}
                    icon={Icon}
                    selected={isShown}
                />
            )}
...
migratePluginSettings("RetributionToolbox", "VencordToolbox");
export default definePlugin({
    name: "RetributionToolbox",
    description: "Adds a button next to the inbox button in the channel header that houses Retribution quick actions",
