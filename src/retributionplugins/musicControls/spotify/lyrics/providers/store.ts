...
import { getLyrics, lyricFetchers, providers, updateLyrics } from "@retributionplugins/musicControls/spotify/lyrics/api";
import { SpotifyStore, type Track } from "@retributionplugins/musicControls/spotify/SpotifyStore";
