...
import { LyricsData, Provider } from "@retributionplugins/musicControls/spotify/lyrics/providers/types";
import { Track } from "@retributionplugins/musicControls/spotify/SpotifyStore";
...
export async function getLyricsLrclib(track: Track): Promise<LyricsData | null> {
    ...
    const response = await fetch(url, {
        headers: {
            "User-Agent": "SpotifyLyrics for Retribution (https://github.com/Masterjoona/vc-spotifylyrics)"
        }
    });
