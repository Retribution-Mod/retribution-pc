...
export default definePlugin({
    ...
    tags: ["Activity"],
    authors: [
        RetributionDevs.vmohammad,
        Devs.AutumnVN,
        RetributionDevs.Crxa,
        Devs.SerStars,
        RetributionDevs.ZcraftElite,
        RetributionDevs.qouesm,
        Devs.RyanCaoDev,
        RetributionDevs.Prince527,
        RetributionDevs.creations,
        RetributionDevs.Star123451,
    ],
