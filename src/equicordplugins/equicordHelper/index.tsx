...
import { Devs, RetributionDevs, GUILD_ID, SUPPORT_CHANNEL_ID, SUPPORT_CHANNEL_IDS, VC_SUPPORT_CHANNEL_IDS } from "@utils/constants";
...
migratePluginToSettings(true, "RetributionHelper", "NoBulletPoints", "noBulletPoints");
migratePluginToSettings(true, "RetributionHelper", "NoModalAnimation", "noModalAnimation");
migratePluginToSettings(true, "RetributionHelper", "GuildTagSettings", "disableAdoptTagPrompt");
...
export default definePlugin({
    ...
    authors: [
        Devs.thororen,
        RetributionDevs.nyx,
        RetributionDevs.Naibuu,
        RetributionDevs.keircn,
        RetributionDevs.SerStars,
        RetributionDevs.mart,
        RetributionDevs.omaw,
        Devs.Samwich,
        Devs.AutumnVN,
        RetributionDevs.auggeeo
    ],
    required: true,
    settings,
    headerBarButton: {
        ...
        async CHANNEL_SELECT({ channelId }) {
            ...
            if (VC_SUPPORT_CHANNEL_IDS.includes(channelId) && !clicked) {
                return Alerts.show({
                    ...
                    body: "Before asking for help. Check updates and if this issue is actually caused by Retribution!",
                    confirmText: "Retribution Support",
                    onConfirm() {
