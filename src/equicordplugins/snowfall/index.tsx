...
export default definePlugin({
    ...
    tags: ["Appearance"],
    authors: [RetributionDevs.ZcraftElite, RetributionDevs.square],
    ...
    settingsAboutComponent: () => (
        <>
            ...
            <Paragraph>
                ...
                <br /><br />
                NOTE: While on most computers this plugin will not impact performance any more than your average Retribution extension,
