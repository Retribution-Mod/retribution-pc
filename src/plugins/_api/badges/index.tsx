...
import { shouldShowContributorBadge, shouldShowRetributionContributorBadge } from "@utils/misc";
import definePlugin from "@utils/types";
import { ContextMenuApi, Menu, Toasts, UserStore } from "@webpack/common";

import Plugins, { PluginMeta } from "~plugins";

import { RetributionDonorModal, RetributionTranslatorModal, VencordDonorModal } from "./modals";

const CONTRIBUTOR_BADGE = "https://cdn.discordapp.com/emojis/1092089799109775453.png?size=64";
const EQUICORD_CONTRIBUTOR_BADGE = "https://raw.githubusercontent.com/Retribution-Mod/retribution-pc/main/browser/icon.png";
const USERPLUGIN_CONTRIBUTOR_BADGE = "https://github.com/Retribution-Mod/retribution-pc/assets/icons/misc/userplugin.png";
...
const RetributionContributorBadge: ProfileBadge = {
    ...
    position: BadgePosition.START,
    shouldShow: ({ userId }) => shouldShowRetributionContributorBadge(userId),
    onClick: (_, { userId }) => openContributorModal(UserStore.getUser(userId)),
    props: {
        style: {
            borderRadius: "50%",
...
let RetributionDonorBadges = {} as Record<string, Array<Record<"tooltip" | "badge", string>>>;
...
async function loadAllBadges(noCache = false) {
    ...
    const retributionBadges = await loadBadges("https://badge.equicord.org/badges.json", noCache);

    DonorBadges = vencordBadges;
    RetributionDonorBadges = retributionBadges;
}
...
export default definePlugin({
    ...
    get RetributionDonorBadges() {
        return RetributionDonorBadges;
    },
    ...
    userProfileBadges: [ContributorBadge, RetributionContributorBadge, UserPluginContributorBadge],
    ...
    getRetributionDonorBadges(userId: string) {
        return RetributionDonorBadges[userId]?.map((badge, idx) => ({
            ...
            onClick() {
                return badge.tooltip === "Retribution Translator" ? RetributionTranslatorModal() : RetributionDonorModal();
            },
        } satisfies ProfileBadge));
    }
});
