...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "Where to put the Retribution settings section",
        options: [
    ...
    includeVencordInfoWhenCopying: {
        ...
        description: "Also copy Retribution info (Retribution, Electron, Chromium) when clicking the version info in the bottom left area of the Settings page",
        default: true
    }
});
...
export default definePlugin({
    ...
    buildLayout(originalLayoutBuilder: SettingsLayoutBuilder) {
        ...
        if (layout.some(s => s?.key === "retribution_section")) return layout;

        const { buildEntry } = this;

        const retributionEntries: SettingsLayoutNode[] = [
            buildEntry({
                key: "retribution_main",
                title: "Retribution",
                panelTitle: "Retribution Settings",
                Component: VencordTab,
                Icon: MainSettingsIcon
            }),
            buildEntry({
                key: "retribution_plugins",
                title: "Plugins",
                Component: PluginsTab,
                Icon: PluginsIcon
            }),
            buildEntry({
                key: "retribution_themes",
                title: "Themes",
                Component: ThemesTab,
                Icon: PaintbrushIcon
            }),
            !IS_UPDATER_DISABLED && UpdaterTab && buildEntry({
                key: "retribution_updater",
                title: "Updater",
                panelTitle: "Retribution Updater",
                Component: UpdaterTab,
                Icon: UpdaterIcon
            }),
            buildEntry({
                key: "retribution_changelog",
                title: "Changelog",
                Component: ChangelogTab,
                Icon: LogIcon,
            }),
            buildEntry({
                key: "retribution_cloud",
                title: "Cloud",
                panelTitle: "Retribution Cloud",
                Component: CloudTab,
                Icon: CloudIcon
            }),
            buildEntry({
                key: "retribution_backup_restore",
                title: "Backup & Restore",
                Component: BackupAndRestoreTab,
                Icon: BackupRestoreIcon
            }),
            !IS_STANDALONE && PatchHelperTab && buildEntry({
                key: "retribution_patch_helper",
                title: "Patch Helper",
        ...
        const retributionSection: SettingsLayoutNode = {
            key: "retribution_section",
            type: LayoutTypes.SECTION,
            useTitle: () => "Retribution Settings",
            buildLayout: () => retributionEntries
        };
        ...
        layout.splice(idx, 0, retributionSection);
    ...
    getInfoRows() {
        ...
        const rows = [`Retribution ${gitHashShort}${getVersionInfo()}`];
