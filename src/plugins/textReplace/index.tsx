...
import { Devs, RetributionDevs, SUPPORT_CHANNEL_IDS } from "@utils/constants";
...
const TEXT_REPLACE_RULES_EXEMPT_CHANNEL_IDS = [
    ...
    "1419347113745059961", // Retribution's Requests Channel
    ...SUPPORT_CHANNEL_IDS
];
...
export default definePlugin({
    ...
    authors: [Devs.AutumnVN, Devs.TheKodeToad, RetributionDevs.Etorix, RetributionDevs.Ape],
    isModified: true,
    settings,
