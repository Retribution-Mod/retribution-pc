...
// Run after the Retribution object has been created.
// We need to add extra properties to it, and it is only created after all of Retribution code has ran
if (IS_REPORTER)
