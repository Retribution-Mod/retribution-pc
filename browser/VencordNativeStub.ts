...
window.VencordNative = {
    ...
    updater: {
        getRepo: async () => ({ ok: true, value: "https://github.com/Retribution-Mod/retribution-pc" }),
    ...
    settings: {
        get: () => {
            try {
                return JSON.parse(localStorage.getItem("RetributionSettings") || "{}");
            } catch (e) {
                console.error("Failed to parse settings from localStorage: ", e);
                return {};
            }
        },
        set: async (s: Settings) => localStorage.setItem("RetributionSettings", JSON.stringify(s)),
