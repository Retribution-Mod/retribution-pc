...
Retribution is a community project and welcomes any kind of contribution from anyone!
...
To keep Retribution stable, secure and maintainable, all plugins must follow these rules:
...
## Improving Retribution Itself

If you want to improve Retribution beyond plugins, such as internal features or performance improvements, you are welcome to open a feature request so it can be discussed.

Bug fixes, refactors, and documentation improvements are also highly appreciated!

## Helping the Community

We have an open support channel in our [Discord community](https://github.com/Retribution-Mod/retribution-pc/discord).
