...
const buildConfigs = [
    ...
    },
    {
        ...
        outfile: "dist/Retribution.user.js",
        banner: {
...
async function buildExtension(target, files) {
    const entries = {
        "dist/Retribution.js": await readFile("dist/browser/extension.js"),
        "dist/Retribution.css": await readFile("dist/browser/extension.css"),
...
const appendCssRuntime = readFile("dist/Retribution.user.css", "utf-8").then(content => {
    const cssRuntime = `unsafeWindow._vcUserScriptRendererCss=\`${content.replaceAll("`", "\\`")}\``;

    return appendFile("dist/Retribution.user.js", cssRuntime);
});
